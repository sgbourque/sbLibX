...
VSTPluginMain (or a "main" variant) :
c.f. 
...
//------------------------------------------------------------------------
	...
	virtual result_t SB_STDCALL initialize (FUnknown* context) = 0;
...
//------------------------------------------------------------------------
	PFactoryInfo (const char8* _vendor, const char8* _url, const char8* _email, int32_t _flags)
	{
...
//------------------------------------------------------------------------
	...
	int32_t cardinality;              ///< cardinality of the class, set to kManyInstances (see \ref ClassCardinality)
...
//------------------------------------------------------------------------
	...
	PClassInfo (const TUID _cid, int32_t _cardinality, const char8* _category, const char8* _name)
	{
...
//------------------------------------------------------------------------
	...
	virtual result_t SB_STDCALL getFactoryInfo (PFactoryInfo* info) = 0;
	...
	virtual result_t SB_STDCALL getClassInfo (int32_t index, PClassInfo* info) = 0;

	/** Create a new class instance. */
	virtual result_t SB_STDCALL createInstance (FIDString cid, FIDString _iid, void** obj) = 0;
...
//------------------------------------------------------------------------
	...
	uint32_t classFlags;				///< flags used for a specific category, must be defined where category is defined
...
//------------------------------------------------------------------------
	...
	PClassInfo2 (const TUID _cid, int32_t _cardinality, const char8* _category, const char8* _name,
		int32_t _classFlags, const char8* _subCategories, const char8* _vendor, const char8* _version,
...
//------------------------------------------------------------------------
	...
	virtual result_t SB_STDCALL getClassInfo2 (int32_t index, PClassInfo2* info) = 0;
...
//------------------------------------------------------------------------
	...
	int32_t cardinality;					///< see \ref PClassInfo
...
//------------------------------------------------------------------------
	PClassInfoW (const TUID _cid, int32_t _cardinality, const char8* _category, const char16* _name,
		int32_t _classFlags, const char8* _subCategories, const char16* _vendor, const char16* _version,
...
//------------------------------------------------------------------------
	...
	virtual result_t SB_STDCALL getClassInfoUnicode (int32_t index, PClassInfoW* info) = 0;

	/** Receives information about host*/
	virtual result_t SB_STDCALL setHostContext (FUnknown* context) = 0;
...
A typical implementation of GetPluginFactory looks like this
						\code
	IPluginFactory* SB_STDCALL GetPluginFactory ()
	{
		if (!gPluginFactory)
		{
...
extern "C"
{
	Steinberg::IPluginFactory* SB_STDCALL GetPluginFactory ();
	typedef Steinberg::IPluginFactory* (SB_STDCALL *GetFactoryProc) ();
}
