...
namespace SB
{
	...
	struct ARCH_x86;
		...
		#endif
		#if   _M_IX86 < 200
			SBCOMPILE_MESSAGE( "| • Compiled for 8086/88 or 186 (" CSTR(_M_IX86) ")" )
		#elif _M_IX86 < 300
			SBCOMPILE_MESSAGE( "| • Compiled for 286 (" CSTR(_M_IX86) ")" )
		#elif _M_IX86 < 400
			SBCOMPILE_MESSAGE( "| • Compiled for 386 (" CSTR(_M_IX86) ")" )
		#elif _M_IX86 < 500
			SBCOMPILE_MESSAGE( "| • Compiled for 486 (" CSTR(_M_IX86) ")" )
		#elif _M_IX86 < 600
			SBCOMPILE_MESSAGE( "| • Compiled for pentium (" CSTR(_M_IX86) ")" )
		#elif _M_IX86 < 700
			SBCOMPILE_MESSAGE( "| • Compiled for pentium pro/pentium II/pentium III or better CPU (" CSTR(_M_IX86) ")" )
		#else
			SBCOMPILE_MESSAGE( "| • Compiled for x86 generation " CSTR(_M_IX86) )
		#endif
	#endif
		...
		#endif
		#if   _M_IX86_FP < 1
			SBCOMPILE_MESSAGE( "| • Compiled using no SIMD intrinsic (" CSTR(_M_IX86_FP) ")" )
		#elif _M_IX86_FP < 2
			SBCOMPILE_MESSAGE( "| • Compiled using SSE intrinsic (" CSTR(_M_IX86_FP) ")" )
		#elif _M_IX86_FP < 3
			SBCOMPILE_MESSAGE( "| • Compiled using SSE2 intrinsic (" CSTR(_M_IX86_FP) ")" )
		#else
			SBCOMPILE_MESSAGE( "| • Compiled using SIMD intrinsic generation " CSTR(_M_IX86_FP) )
		#endif
	#endif
